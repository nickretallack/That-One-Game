...
(function() {
  var Animated, Board, Meter, Tile, Timer, V, Vector, cardinals, delay, fall_speed, get_time, random_choice, tile_size, tile_types,
  ...
  Timer = (function(_super) {
    ...
    function Timer(_arg) {
      this.element = _arg.element, this.time_limit = _arg.time_limit;
    ...
    Timer.prototype.animate = function() {
      ...
      this.element.text(Math.ceil(this.time_remaining / 1000.0));
      return webkitRequestAnimationFrame(this.animate);
    };
